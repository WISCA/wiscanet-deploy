...
%
    ...
    bkTrnSyms        = fdbckMsgCodeBook{n}.trnSymbols;
    bkSpreadIdx      = fdbckMsgCodeBook{n}.spreadIdx;
    bkPermSeqEncoder = fdbckMsgCodeBook{n}.permSeqEncoder;
    bkPermSeqIntrlvr = fdbckMsgCodeBook{n}.permSeqIntrlvr;
    bkTrellisStruct  = fdbckMsgCodeBook{n}.trellisStruct;
    
    % Feedforward message variables
    nFwdEncBits       = fdfwdMsgCodeBook{n}.nEncdBits;
    fwdTrnSyms        = fdfwdMsgCodeBook{n}.trnSymbols;
    fwdSpreadIdx      = fdfwdMsgCodeBook{n}.spreadIdx;
    fwdPermSeqEncoder = fdfwdMsgCodeBook{n}.permSeqEncoder;
    fwdPermSeqIntrlvr = fdfwdMsgCodeBook{n}.permSeqIntrlvr;
    fwdTrellisStruct  = fdfwdMsgCodeBook{n}.trellisStruct;
